# Software Spec - CHANGE-065 - Implement Agent Integration Registry MVP
...
- Change Set: `CHANGE-065`
- Change path: `.p2p/changes/CHANGE-065-implement-agent-integration-registry-mvp`
- Included proposals: PROP-006
