...
- Path: `.p2p/registries`
- Stale: `False`
- Source proposals: 101
- Source changes: 69

## Proposals Registry

- PROP-001: accepted - — CLI Foundation
- PROP-002: accepted - Proposal Exploration And Readiness Workflow
...
- PROP-006: accepted - Multi-Agent Integration Model
- PROP-007: superseded - Proposal Intake and Overlap Analysis
- PROP-008: superseded - Governance Model
...
- PROP-038: accepted - Managed Work Merge Conflict Guidance MVP
- PROP-039: accepted - Managed Work Finalize MVP
- PROP-040: accepted - Managed Work Cleanup MVP
- PROP-041: accepted - Remote Project Profile and Review Request Policy
- PROP-042: accepted - P2P Core CLI MCP Mediator Web Boundary
- PROP-043: accepted - Managed Work Retire MVP
- PROP-044: accepted - P2P MCP Server MVP
- PROP-045: accepted - Agent-Safe Project Bootstrap MVP
- PROP-046: accepted - MCP Write-Safe Bootstrap Tools MVP
- PROP-047: accepted - Guided Init Wizard MVP
- PROP-048: accepted - MCP Level 3 Proposal and Intake Draft Tools
- PROP-049: accepted - MCP Level 4A Proposal Refinement Tools
- PROP-050: accepted - MCP Level 4B Choice Conflict Impact Advisory Tools
...
- CHANGE-024: completed - Managed Work Merge Conflict Guidance MVP (proposals: PROP-038)
- CHANGE-025: completed - Managed Work Finalize MVP (proposals: PROP-039)
- CHANGE-026: completed - Managed Work Cleanup MVP (proposals: PROP-040)
- CHANGE-027: completed - Remote Project Profile and Review Request Policy (proposals: PROP-041)
- CHANGE-028: completed - Managed Work Retire MVP (proposals: PROP-043)
- CHANGE-029: completed - P2P MCP Server MVP (proposals: PROP-044)
- CHANGE-030: completed - Agent-Safe Project Bootstrap MVP (proposals: PROP-045)
- CHANGE-031: completed - MCP Write-Safe Bootstrap Tools MVP (proposals: PROP-046)
- CHANGE-032: completed - Guided Init Wizard MVP (proposals: PROP-047)
- CHANGE-033: completed - MCP Level 3 Proposal and Intake Draft Tools (proposals: PROP-048)
- CHANGE-034: completed - MCP Level 4A Proposal Refinement Tools (proposals: PROP-049)
- CHANGE-035: completed - MCP Level 4B Choice Conflict Impact Advisory Tools (proposals: PROP-050)
- CHANGE-036: completed - Draft Proposal Next Action and Agent Explanation Guard (proposals: PROP-051)
- CHANGE-037: completed - MCP Proposal Contribution Tool (proposals: PROP-052)
- CHANGE-038: completed - Core Validation Layer MVP (proposals: PROP-053)
- CHANGE-039: completed - Project Readiness Assessment MVP (proposals: PROP-054)
- CHANGE-040: completed - Agent Token Budget Context MVP (proposals: PROP-055)
- CHANGE-041: completed - Project Definition Maturity Rubrics MVP (proposals: PROP-056)
- CHANGE-042: completed - Guided Rubric Selection MVP (proposals: PROP-057)
- CHANGE-043: completed - README and Install Documentation MVP (proposals: PROP-058)
- CHANGE-044: completed - Focused README and Documentation Map MVP (proposals: PROP-061)
- CHANGE-045: completed - README Product Landing Page Refinement (proposals: PROP-062)
- CHANGE-046: completed - Spec Kit Three-Prompt Export Model (proposals: PROP-064)
- CHANGE-047: completed - MCP Agent-First Coverage Expansion (proposals: PROP-065)
- CHANGE-048: completed - Agent-First Setup Documentation Split (proposals: PROP-067)
- CHANGE-049: completed - Document Agent MCP Client Setup Commands (proposals: PROP-068)
- CHANGE-050: completed - Clarify MCP Stdio Integration Model (proposals: PROP-069)
...
- CHANGE-024 -> PROP-038 (includes)
- CHANGE-025 -> PROP-039 (includes)
- CHANGE-026 -> PROP-040 (includes)
- CHANGE-027 -> PROP-041 (includes)
- CHANGE-028 -> PROP-043 (includes)
- CHANGE-029 -> PROP-044 (includes)
- CHANGE-030 -> PROP-045 (includes)
- CHANGE-031 -> PROP-046 (includes)
- CHANGE-032 -> PROP-047 (includes)
- CHANGE-033 -> PROP-048 (includes)
- CHANGE-034 -> PROP-049 (includes)
- CHANGE-035 -> PROP-050 (includes)
- CHANGE-036 -> PROP-051 (includes)
- CHANGE-037 -> PROP-052 (includes)
- CHANGE-038 -> PROP-053 (includes)
- CHANGE-039 -> PROP-054 (includes)
- CHANGE-040 -> PROP-055 (includes)
- CHANGE-041 -> PROP-056 (includes)
- CHANGE-042 -> PROP-057 (includes)
- CHANGE-043 -> PROP-058 (includes)
- CHANGE-044 -> PROP-061 (includes)
- CHANGE-045 -> PROP-062 (includes)
- CHANGE-046 -> PROP-064 (includes)
- CHANGE-047 -> PROP-065 (includes)
- CHANGE-048 -> PROP-067 (includes)
- CHANGE-049 -> PROP-068 (includes)
- CHANGE-050 -> PROP-069 (includes)
...
- `real-test-coverage-reporting` from PROP-060
...
- `readiness-assessment-refresh-and-review-workflow` from PROP-082
- `domain-aware-visible-project-definition-export` from PROP-083
- `project-local-runtime-bootstrap-and-upgrade-flow` from PROP-084
- `pluggable-project-verticals-and-readiness-orchestration` from PROP-085
- `artifact-aware-proposal-readiness-and-agent-interview-orchestration` from PROP-086
- `agent-personality-model-for-decision-mediation` from PROP-087
- `mcp-artifact-import-parity` from PROP-088
- `readiness-question-state-convergence` from PROP-089
- `project-vertical-pack-runtime-hardening-and-definition-state` from PROP-090
- `governance-policy-convergence` from PROP-091
- `local-mcp-work-lifecycle-parity-and-remote-gateway-boundary` from PROP-092
- `agent-persistence-boundaries-and-proposal-authoring-flow` from PROP-093
- `p2p-governed-software-specification-lifecycle` from PROP-094
- `project-runtime-contract-update-lifecycle` from PROP-095
- `readiness-evidence-quality-and-question-state-normalization` from PROP-096
- `runtime-contract-adoption-for-legacy-projects` from PROP-097
- `project-output-lifecycle-and-retention-policy` from PROP-099
- `project-decision-context-index-and-proposal-neighborhood` from PROP-100
- `project-readiness-convergence-workflow` from PROP-101
...
- INTAKE-002: analyzed - Recommendation - INTAKE-002
- INTAKE-003: analyzed - Recommendation - INTAKE-003
