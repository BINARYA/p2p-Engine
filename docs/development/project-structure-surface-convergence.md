...
This is the P2P Engine 0.6.4 release-gate note for converging the project-owned
...
The release notes state that P2P Engine 0.6.4 preserves the clean boundary:
