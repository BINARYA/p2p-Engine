...
This is the P2P Engine 0.6.5 release-gate note for converging the project-owned
...
The release notes state that P2P Engine 0.6.5 preserves the clean boundary:
