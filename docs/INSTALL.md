...
.venv/bin/python -m pip install \
  https://github.com/BINARYA/p2p-Engine/releases/download/v0.4.5/p2p_engine-0.4.5-py3-none-any.whl
```

Replace `v0.4.5` and `p2p_engine-0.4.5-py3-none-any.whl` with the release you
...
git tag -a v0.4.5 -m "P2P Engine v0.4.5"
...
The tag must match `pyproject.toml`: tag `v0.4.5` requires
`version = "0.4.5"`. Do not reuse an existing version or tag for different
contents.
...
```text
v0.4.5 -> p2p_engine-0.4.5-py3-none-any.whl, p2p_engine-0.4.5.tar.gz
```
