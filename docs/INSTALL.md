...
.venv/bin/python -m pip install \
  https://github.com/BINARYA/p2p-Engine/releases/download/v0.4.3/p2p_engine-0.4.3-py3-none-any.whl
```

Replace `v0.4.3` and `p2p_engine-0.4.3-py3-none-any.whl` with the release you
...
git tag -a v0.4.3 -m "P2P Engine v0.4.3"
...
The tag must match `pyproject.toml`: tag `v0.4.3` requires
`version = "0.4.3"`. Do not reuse an existing version or tag for different
contents.
...
```text
v0.4.3 -> p2p_engine-0.4.3-py3-none-any.whl, p2p_engine-0.4.3.tar.gz
```
