...
- profile: `outputs/latest/publications/project-it/profile.yml`
- profile_sha256: `88cec0b18502eed762b845593a61129f21e974d2abb4730ab36df9b67255463e`
...
- markdown: `drafts/project-publication/project-it.md`
- project_model: `drafts/project-publication/project-it.model.yml`
- evidence_accounting: `drafts/project-publication/project-it.evidence.yml`

## Candidate Binding Contract

Set the project-model bindings exactly as follows:

- `curator_packet_sha256`: physical SHA256 of `outputs/latest/publications/project-it/curator-input.md`
...
```bash
p2p project publish import drafts/project-publication/project-it.md \
  --model drafts/project-publication/project-it.model.yml \
  --evidence-accounting drafts/project-publication/project-it.evidence.yml \
  --language it --output-name project
```
