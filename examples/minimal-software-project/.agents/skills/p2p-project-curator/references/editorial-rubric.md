...
Adapter: codex
Template: codex-p2p-project-curator-editorial-rubric-v3
Generation: agent-template-generation-v2:agent-capabilities-v4:codex-p2p-project-curator-editorial-rubric-v3
