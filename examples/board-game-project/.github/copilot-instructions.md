...
Adapter: copilot
Template: copilot-instructions-v2
Generation: agent-template-generation-v2:agent-capabilities-v5:copilot-instructions-v2
Do not edit generated sections unless you accept drift.
-->

# GitHub Copilot Instructions - Cooperative Shrine Game
