...
Generation: agent-template-generation-v2:agent-capabilities-v9:generic-agents-md-v2
Do not edit generated sections unless you accept drift.
-->

# Agent Instructions - Cooperative Shrine Game
...
- project definition work: Use project structure/context/definition primitives before creating durable artifacts.
...
- vertical specific primitives: Use applicable release-specific primitives without treating source identity as live project structure.
