...
| R-F5-024..031 | D022-D026; Pre-Migration Owner Attestation | H-T001..014, D2-T001..006 | closed input normalization, `MigrationAttestationTemplate`, `WorkspaceCompatibilityService.proposal_decision_attestation_template`, attested v2-to-v3 event construction, exact source/owner checks, CLI template and published/installed `v0.4.1` parity | complete |
...
| R-F9-005..009 | Repository Migration | H-T001..014, D2-T001..006, M-T001..016 | owner-confirmed plan `14829c8f...bc642` applied as transaction `migration-6fc36d34399ec5c9`; six residual cases were individually owner-curated, including two append-only lineage closures; schema v3, 102 ledgers, zero unknown authority, clean validation and no-op re-plan `6d2d82...deb491` | complete |
| R-F9-010..014 | Derived Alignment | A-T001..014 | registries and 97-proposal project projection current; context `1486/3249/2495/716/1019`; assessment/maturity/progress refreshed; 13 specs classified; 18 stable next actions; export `ad48e9...bede0`, curated Markdown `7c8fff...e67bd`, validation and PDF current; review remains unapproved | complete; 12 legacy specs and inherited freshness are explicitly review-controlled |
...
| N016..020 | G-T006..012, D-T002..008, A-T013, F-T004 | compile/version checks, Python 3.11/3.14 release evidence, final local public `260 passed`, full `1238 passed`, verified wheel/sdist and isolated installed-artifact smoke | complete |
...
| AC026..028 | G, D, F-T004 | release matrix remained green; final local source public `260 passed`, full `1238 passed`, package contract `11 passed`, wheel SHA-256 `97eed5...d8f0`, sdist SHA-256 `b61541...f4f8a` and clean isolated schema-v3 smoke | complete |
| AC029..030 | D, M, A, F-T001..012 | owner-authorized runtime deployment and repository migration; 102 valid ledgers, zero unknown authority, no-op v3 plan `6d2d82...deb491`; derived pre/post comparison, owner-confirmed `CHANGE-070` completion, current publication manifest and `approved_for_publication=false` | complete |
| AC031..034 | H-T010..014, D2-T001..006 | exact/missing/stale attestation, conditional acceptance, unsupported lineage, no-write template, CLI, lock-time source drift and atomic apply tests; Python 3.14 `1234 passed`, Python 3.11 `1233 passed, 1 skipped`, verified published wheel/sdist and byte-identical active-runtime template/plan/help | complete |
...
| D2 | complete | owner-authorized `v0.4.1` at `af101208`; workflow `29685780911`, published wheel/sdist digests and active installed-runtime parity verified |
| M | complete | schema v3 applied; all six residual authorities owner-curated; `PROP-007` split to `PROP-017`/`PROP-025`, `PROP-008` superseded by `PROP-091`; zero unknown authority, clean validation and no-op re-plan |
| A | complete | all deterministic owners rerun; publication technical stages current; 12 `unknown_origin` specs, inherited freshness and owner review are explicitly lifecycle-controlled |
| F | complete | owner-confirmed `CHANGE-070` transitions through `in_review` to `completed`; final handoff, publication-state verification and exit evidence recorded |
